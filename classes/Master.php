...
Class Master extends DBConnection {
	...
	function save_category(){
		...
		if($save){
			$resp['status'] = 'success';
			if(empty($id))
				$this->settings->set_flashdata('success',"Nueva categoría guardada correctamente.");
			else
				$this->settings->set_flashdata('success',"Categoría actualizada correctamente.");
		}else{
			$resp['status'] = 'failed';
	...
	function delete_category(){
		...
		if($del){
			$resp['status'] = 'success';
			$this->settings->set_flashdata('success',"Categoría eliminada correctamente.");
		}else{
			$resp['status'] = 'failed';
			$resp['error'] = $this->conn->error;
		}
	...
	function save_product(){
		...
		if($save){
			$resp['status'] = 'success';
			if(empty($id))
				$this->settings->set_flashdata('success',"Nuevo producto guardado correctamente.");
			else
	...
	function save_service(){
		...
		if($save){
			$resp['status'] = 'success';
			if(empty($id))
				$this->settings->set_flashdata('success',"Nuevo servicio guardado correctamente.");
			else
				$this->settings->set_flashdata('success',"Servicio actualizado correctamente.");
		}else{
			$resp['status'] = 'failed';
			$resp['err'] = $this->conn->error."[{$sql}]";
		}
	...
	function delete_service(){
		...
		if($del){
			$resp['status'] = 'success';
			$this->settings->set_flashdata('success',"Servicio eliminado correctamente.");
		}else{
			$resp['status'] = 'failed';
			$resp['error'] = $this->conn->error;
		}
	...
	function save_invoice(){
		...
		$this->settings->set_flashdata('success',"Factura guardada correctamente.");
		return json_encode($resp);
	}
	function delete_invoice(){
		...
		if($del && $del2){
			$resp['status'] = 'success';
			$this->settings->set_flashdata('success',"Factura eliminada correctamente.");
		}else{
			$resp['status'] = 'failed';
			$resp['error'] = $this->conn->error;
		}
