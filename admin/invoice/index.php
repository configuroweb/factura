...
<div class="card card-outline card-primary">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="./?page=invoice/manage" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span>  Crear Nueva</a>
		</div>
	</div>
	<div class="card-body">
					...
					?>
						<tr>
							...
							<td>
								...
								<p class="m-0"><small><b>Cuenta de Producto:</b> <?php echo number_format($items) ?></small></p>
								<p class="m-0"><small><b>Monto Total:</b><?php echo number_format($row['total_amount']) ?></small></p>
							</td>
							<td align="center">
