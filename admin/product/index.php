...
<div class="card card-outline card-primary">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="javascript:void(0)" id="create_product" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span>  Crear Nuevo</a>
		</div>
	</div>
	<div class="card-body">
...
<script>
	$(document).ready(function(){
		$('#create_product').click(function(){
			uni_modal("<i class='fa fa-plus'></i> Nuevo Producto","product/manage.php","mid-large")
		})
		$('.edit_data').click(function(){
			uni_modal("<i class='fa fa-edit'></i> Actualizar Producto","product/manage.php?id="+$(this).attr('data-id'),"mid-large")
		})
